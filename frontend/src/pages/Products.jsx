...
import {
  Search, X, SlidersHorizontal, Filter, ChevronDown,
...
const Products = () => {
  ...
  const filteredProducts = useMemo(() => {
    let filtered = allProducts.filter((product) => {
      ...
      return matchesSearch && matchesCategory && matchesSubCategory &&
             matchesBrand && matchesColor && matchesPrice && matchesStock;
    });
    ...
    return filtered;
  }, [searchQuery, selectedCategories, selectedSubCategories, selectedBrands,
      selectedColors, priceRange, inStockOnly, sortBy]);
  ...
  const activeFilterCount = selectedCategories.length + selectedSubCategories.length +
                           selectedBrands.length + selectedColors.length + (inStockOnly ? 1 : 0);
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-2">
                      ...
                      <h2 className="text-xl font-black text-gray-900 uppercase">Filters</h2>
                      {activeFilterCount > 0 && (
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 ? (
              ...
              >
                ...
                <button
                  onClick={clearAllFilters}
                  className="bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white px-8 py-3 rounded-xl font-black uppercase shadow-lg transition-all"
                >
                  Clear All Filters
                </button>
              </motion.div>
                  ...
                  <AnimatePresence>
                    {filteredProducts.map((product) => (
                      ...
                      >
                        ...
                        <div className="p-3">
                          <p className="text-xs font-bold text-red-500 mb-1">{product.brand}</p>
